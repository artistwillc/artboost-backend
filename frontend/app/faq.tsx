...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "ArtBoost can use supported Redbubble storefront, collection, or individual-listing links. Choose the import option that matches the link you are using.",
    steps: [
      "Open Connect.",
      "Select Stores.",
      "Choose Redbubble.",
      "Select Import Store, Import Collection, or Import Single Listing.",
      "Paste the appropriate Redbubble link.",
      "Start the import.",
      "Review the imported products in the Library.",
    ],
    keywords: [
      "redbubble",
      "import store",
