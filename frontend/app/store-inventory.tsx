    ...
    <SafeAreaView style={styles.screen}>
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          <Text style={styles.eyebrow}>CATALOG STATUS</Text>
          <Text style={styles.title}>Inventory</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.storeCard}>
          <Ionicons name="layers-outline" size={26} color="#c4b5fd" />
          <View style={{flex:1}}>
        ...
        <View style={styles.card}><Text style={styles.cardTitle}>Imported Catalog Inventory</Text><Text style={styles.cardText}>Inventory reflects the products ArtBoost has imported for this store. Availability and listing details depend on what the connected store or scanner provides; ArtBoost does not invent stock quantities that the source does not expose.</Text></View><View style={styles.card}><Text style={styles.cardTitle}>Keep it current</Text><Text style={styles.cardText}>Use Sync Now on the Store Dashboard before reviewing inventory when you need the newest catalog state.</Text></View>
