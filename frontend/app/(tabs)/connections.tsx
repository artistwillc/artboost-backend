...
const storePlatforms: PlatformItem[] = [
  {
    name: "Shopify",
    description:
      "Import products and automate store marketing.",
    premium: true,
    available: true,
  ...
  },
  {
    name: "Etsy",
    description:
      "Import Etsy listings and automate store marketing.",
    premium: true,
    available: true,
    connectionType: "Live Sync",
  },
  {
    name: "Redbubble",
    description:
      "Import artwork and automate store marketing.",
    premium: true,
    available: true,
    connectionType: "Artwork Import",
  },
];
...
const connectRedbubble = async () => {
  router.push({
    pathname: "/connect-store" as any,
    params: {
      preferredType: "redbubble",
    },
  });
};
       
  const openUniversalStoreConnector = () => {
    router.push({
      pathname: "/connect-store" as any,
    });
  };
    ...
    >
      ...
      <View style={styles.proBox}>
        ...
        <Text style={styles.proText}>
          {activeSection === "social"
            ...
            : "Connect any store or website where your artwork and products are sold."}
        </Text>
      </View>
      ...
      {activeSection === "stores" ? (
        <>
          ...
          >
            <Text style={styles.connectStorePlus}>
              +
            </Text>
            ...
            <View style={styles.connectStoreTextWrap}>
              ...
              <Text style={styles.connectStoreDescription}>
                Connect Shopify, Redbubble, Etsy, your own website, or another online store.
              </Text>
            </View>
          </Pressable>

          <Text style={styles.connectedStoresTitle}>
            Connected Stores
          </Text>
          ...
          {visiblePlatforms.length === 0 ? (
            <View style={styles.emptyStoresCard}>
              ...
              <Text style={styles.emptyStoresText}>
                Connect your first store to import listings and start automatic marketing.
              </Text>
            </View>
          ) : null}
        </>
