...
- ARTBOOST_PRODUCT_POST_HASHTAG_INTELLIGENCE_V1: Build hashtags from the actual design subject, niche, audience, occupation/hobby/community, buyer intent, product category, title, description, and visible image context when available. Rank the strongest 5 discovery keyword concepts first. Avoid generic filler and unrelated viral tags. #Streetwear, #HustleHard, #FYP, #Viral, and #Trending are forbidden unless the product itself explicitly makes them relevant.\n- Do not include the product URL inside caption, title, hashtags, or altText. ArtBoost attaches it separately where appropriate.\n- Hashtags must be relevant to the actual product.\n- CTA must match the selected platform's link behavior.\n- altText should objectively describe the product image for accessibility, without sales language.\n- Avoid spammy all-caps language and excessive emojis.\n- Do not mention ArtBoost AI unless the product itself is ArtBoost AI.`;
